    ...
    >
      ...
      <div className="flex justify-center mb-20 lg:mb-32">
        <div className="flex items-center">
          ...
          <span className="bg-[#050505] border border-red-600/30 text-white p-3 px-8 text-2xl font-bold rounded-full shadow-[0_0_20px_rgba(220,38,38,0.2)]">
      ...
      <div className="max-w-6xl mx-auto px-4 relative">
        ...
        {/* Timeline line */}
        <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-red-600 via-red-900 to-transparent opacity-40" />
            ...
            <div key={exp.id} className="relative">
              ...
              <SectionReveal direction={index % 2 === 0 ? "right" : "left"}>
                ...
                >
                  ...
                  {/* Timeline Icon */}
                  <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 w-10 h-10 rounded-xl bg-[#050505] border-2 border-red-600 flex items-center justify-center z-10 shadow-[0_0_15px_rgba(220,38,38,0.5)]">
